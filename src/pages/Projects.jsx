...
const ProjectCard = ({ project, isExpanded, onToggle }) => {
  return (
    <motion.div
      layout
      className={`dc-card overflow-hidden cursor-pointer transition-all duration-500 ${
...
const Projects = () => {
  ...
  return (
    <Layout>
      <Helmet>
        <title>DevCatalyst | Projects</title>
        <meta name="description" content="Explore our community's innovative projects and built solutions." />
      </Helmet>
